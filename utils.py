...
def get_cifar10_loaders(batch_size=128, num_workers=4, augment=True, val_split=5000, seed=42):
    ...
    # Building the training transform pipeline
    train_transforms = []
    ...
    # Composing all training transformations
    ...
    # Setting random seed for reproducibility of the train/validation split
    ...
    # Returning all three DataLoaders
